  ...
  return (
    <>
      ...
      <main className="text-white">
        ...
        {/* Partners Section */}
          <div className="w-[1900px] h-[1104px] px-36 pt-28 pb-56 bg-orange-50 inline-flex flex-col justify-center items-center gap-10">
    <div className="w-[980px] max-w-[1180px] border-b-[0.50px] border-neutral-600 inline-flex justify-between items-start">
        <div className="py-14 border-t-[0.50px] border-neutral-600 inline-flex flex-col justify-start items-center gap-10">
            <div className="w-80 h-40 relative">
                <img className="w-80 h-40 left-0 top-0 absolute" src="/cc.png" />
            </div>
            <div className="w-96 flex flex-col justify-center items-start gap-14">
                <div className="self-stretch text-center justify-start text-neutral-600 text-lg font-normal font-['Geist'] leading-normal">Sudhanand Group, a leader in healthcare, IT, and education services, has partnered with Cabrillo Coastal, a specialist in property insurance for high-risk coastal areas. Together, they enhance claims processing, customer support, and service efficiency by combining Sudhanand’s operational expertise with Cabrillo’s commitment to quality insurance solutions.<br/><br/>This collaboration provides integrated, reliable offerings in healthcare and property protection, ensuring accessibility and efficiency for clients. Their joint efforts drive innovation and excellence, setting new standards across both critical sectors.</div>
            </div>
        </div>
        <div className="self-stretch py-14 border-t-[0.50px] border-neutral-600 inline-flex flex-col justify-start items-center gap-10">
            <div className="w-80 h-40 relative">
                <img className="w-80 h-40 left-0 top-0 absolute" src="/creditgram.png" />
            </div>
            <div className="w-96 flex flex-col justify-center items-center gap-14">
                <div className="self-stretch text-center justify-start text-neutral-600 text-lg font-normal font-['Geist'] leading-normal">CreditAccess Grameen, a leading microfinance institution in India, empowers low-income communities through financial services that enhance livelihoods and stability. Sudhanand Group provides accessible, quality healthcare to underserved populations. Together, they form a powerful partnership bridging microfinance and healthcare, addressing critical needs in rural and semi-urban areas. This collaboration promotes financial inclusion and improved medical access, enabling communities to thrive. By combining resources and expertise, they drive sustainable socio-economic development and well-being. Their joint efforts reflect a commitment to innovation and impact, empowering individuals and families to build healthier, more financially secure futures.</div>
            </div>
        </div>
    </div>
    <div className="self-stretch inline-flex justify-start items-center gap-24">
        <div className="w-96 justify-start text-neutral-600 text-3xl font-normal font-['Geist'] leading-9">Discover how we can help</div>
        <div data-property-1="Default" className="px-6 py-4 bg-slate-500 rounded-[500px] flex justify-center items-center gap-2.5">
            <div className="text-center justify-start text-white text-lg font-normal font-['Geist'] leading-snug">Contact Us</div>
        </div>
    </div>
</div>
