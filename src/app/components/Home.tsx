...
//   // --- START: New state and data for the video carousel ---
...
//       {/* --- MODIFIED Business Section with Video Carousel --- */}
//       <section
...
//             {/* Desktop View: Grid with play-on-hover */}
//             <div className="hidden md:grid md:grid-cols-3 gap-8 w-full">
//               {videos.map((video, index) => {
//                 // Dynamically build the src. Autoplay is added ONLY if it's the active video.
//                 const videoSrc =
...
//                   <div
//                     key={video.id}
//                     className="relative rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 aspect-video transform hover:scale-105"
//                     // On desktop, hovering over a video makes it active
...
//                         <iframe
//                           src={videoSrc} // Mobile doesn't autoplay to save data
//                           title={video.title}
//                           allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
//                           allowFullScreen
//                           className="w-full h-full"
...
//                       ? 'bg-white scale-125' // Style for the active dot
//                       : 'bg-white/50 hover:bg-white/75' // Style for inactive dots
//                   }`}
